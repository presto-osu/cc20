...
public class MainStats extends BaseMain {
  ...
  void stats() {
    ...
    System.out.println("error_total_freq_est:\t" + stotalfreq.getStdDev());
    ...
    System.out.println("error_total_freq_est_diff:\t" + stotalfreqdiff.getStdDev());
    ...
    System.out.println("error_rel_linf:\t" + srellinf.getStdDev());
    System.out.println("mean_rel_linf_miss:\t" + srellinfmiss.getMean());
    System.out.println("error_rel_linf_miss:\t" + srellinfmiss.getStdDev());
    System.out.println("mean_l1:\t" + sl1.getMean());
    System.out.println("error_l1:\t" + sl1.getStdDev());
    System.out.println("mean_norm_l1:\t" + snorml1.getMean());
    System.out.println("error_norm_l1:\t" + snorml1.getStdDev());
    ...
    //      errorSB.append("\t").append(sPrecision.getStdDev());
    //    }
...
//      System.out.println("mtd_dist_est:\t" + sb);
  ...
  void statsHot(double[][] data, String tag) {
    ...
    for (int idx = data.length - 1; idx >= 0; idx -= 1) {
      ...
      errorSB.append("\t").append(sHot.getStdDev());
    }
    System.out.println(meanSB);
    System.out.println(errorSB);
  }
  ...
  double clip(double val, double low, double high) {
    assert low <= high;
    if (val < low) val = low;
  ...
  void computeAccuracy(int trial_num, Map<String, Double> adjProfile) {
    ...
    for (int idx = 0; idx < 5; idx += 1) {
      ...
      for (String mmm : real_hot_mtd) {
        ...
        x_sum += x;
        // double y = clip(rel(adjProfile.get(mmm), real_sum), 0, 1);
        double y = clip(adjProfile.get(mmm), 0, real_sum);
